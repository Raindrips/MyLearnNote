```
<uses-permission android:name="所需权限" />
...
获取错略位置
通过WiFi或移动基站的方式获取用户错略的经纬度信息,定位精度
大概误差在30~1500米
...
允许程序调用killBackgroundProcesses(String).方法结束后台
进程
...
android.permission.SET_PREFERRED_APPLICATIONS 设置应用参数
设置应用的参数,已不再工作具体查看
